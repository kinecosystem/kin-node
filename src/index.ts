...
import txpbv4 from "@kin-beta/agora-api/node/transaction/v4/transaction_service_pb";
...
export function bigNumberToU64(bn: BigNumber): u64 {
    ...
    b.writeBigUInt64LE(BigInt(bn as any), 0);
    return u64.fromBuffer(b);
}

// Invoice represents a transaction invoice for a single payment.
//
// See https://github.com/kin-beta/agora-api for details.
